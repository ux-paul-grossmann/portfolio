...
const themePanel = document.getElementById('theme-panel-container');
...
var toggleMaterial = document.querySelector(".toggle-material");
...
toggleMaterial.addEventListener("click", function(e) {
    e.preventDefault();
