...
const projectsData = [
  {
    ...
    designedWithIcons: ['xd', 'msteams', 'jira', 'invision'],
  ...
  },
  {
    ...
    designedWithIcons: ['xd', 'msteams', 'jira'],
  ...
  },
  {
    ...
    designedWithIcons: ['vscode', 'bootstrap-4', 'html-5', 'css-3', 'javascript', 'jquery'],
  ...
  },
  {
    ...
    designedWithIcons: ['axure', 'photoshop-cc', 'vscode', 'html-5', 'css-3', 'angular', 'typescript', 'javascript', 'jquery', 'jira', 'github-octocat'],
  ...
  },
  {
    ...
    designedWithIcons: ['illustrator', 'photoshop-cc', 'vscode'],
    prototypeLink: null,
    prototypeText: null,
  ...
  },
  {
    ...
    designedWithIcons: ['illustrator', 'xd'],
...
const projectHierarchy = [
    {
        id: 'veda',
        company: 'VEDA GmbH',
        logo: './lib/images/logos/veda.png',
        projects: [
            projectsData[0],  // Smart Search Bar (Proj01)
            projectsData[1]   // Digitales Verbandbuch (Proj02)
        ]
    },
    {
        id: 'rwth',
        company: 'RWTH Aachen',
        logo: './lib/images/logos/rwth.png',
        projects: [
            projectsData[3],  // Industrie 4.0 (Proj04)
            projectsData[4]   // Senseering (Proj05)
        ]
    },
    {
        id: 'fh',
        company: 'FH Aachen',
        logo: './lib/images/logos/fh.png',
        projects: [
            projectsData[5]   // Mobile Redesign (Proj06)
        ]
    },
    {
        id: 'solo',
        company: 'Eigenprojekte',
        logo: './lib/images/logos/solo.png',
        projects: [
            projectsData[2]   // Sprachzwirbel (Proj03)
        ]
    }
];