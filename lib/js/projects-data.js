...
const projectsData = [
  {
    ...
    designedWithIcons: ['sketching', 'xd', 'jira', 'illustrator'],
    prototypeLink: null,
    prototypeText: null,
    background: 'Das m3connect Dashboard "conn4" wurde einst entwickelt, ohne großen Fokus auf UX und Usability zu geben. In vielen Bereichen war es sehr komplex und brauchte einen Checkup und Optimierung.',
    ...
    goalDetails: 'Verstehen, Experimentieren, Ausarbeiten – nach dem Double Diamond Framework. Methoden: Stakeholder Map, Information Architecture / Sitemap, Heuristische Evaluation nach Nielsen Norman Group, Nutzerumfrage, Nutzerinterviews und Shadowing, Personas, Analytics Metriken Insights (Matomo Tracking).',
