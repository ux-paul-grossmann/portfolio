...
const projectsData = [
  {
    ...
    verwendeTools: [`sketching`, `xd`, `jira`, `miro`, `figma`, `msteams`, `office`],
    prototypeLink: null,
    prototypeText: null,
    finalDesignCarousel: [],
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `xd`, `miro`, `figma`],
    prototypeLink: null,
    prototypeText: null,
    finalDesignCarousel: ['./lib/images/m3c-ui-design-ma-dashboard/ma-dashboard-kiosk-final.png'],
    background: `Das Mitarbeiter Dashboard für m3connect wurde als Touchscreen-Anwendung konzipiert und gestaltet.`,
    duration: ``,
    team: ``,
    goalText: ``,
