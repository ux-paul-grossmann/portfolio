...
const projectsData = [
  {
    id: `Proj07`,
    title: `Conn4 UX Analysis`,
    thumbnailClass: `thumbnail-pic-07`,
    shortDesc: {
      mobile: `UX-Optimierung des m3connect Dashboards`,
      tablet: `UX-Analyse und Optimierung des m3connect conn4 Dashboards`,
      desktop: `UX-Analyse und Optimierung des m3connect conn4 Dashboards`
    },
    tags: [`UX`, `Usability`, `Dashboard`, `Forschung`, `Analyse`, `Optimierung`, `Nutzerzentrierung`],
    verwendeTools: [`jira`, `miro`, `msteams`, `office`],
    prototypeLink: null,
    prototypeText: null,
    finalDesignCarousel: [],
    background: `Das m3connect Dashboard "conn4" auf CMS Basis, jahrelang im Einsatz im Unternehmen als auch ein verkauftes Produkt mit den Zielgruppen in Bereichen der Hospitality, wurde einst entwickelt, ohne großen Fokus auf UX und Usability zu geben. In vielen Bereichen war es sehr komplex und brauchte einen Checkup und Optimierung.`,
    duration: `Juni - Oktober 2023`,
    team: `Anfangs zwei UX Designer (Werkstudent + Praktikant, je 20h/Woche), ab September erweitert um UX & UI Designer (Vollzeit).`,
    goalText: `Nutzer und deren Verhalten verstehen, Pain Points entdecken, Verbesserungspotenziale identifizieren, Nutzerzufriedenheit steigern, Effizienz verbessern, Wechsel zu nutzerzentrierter Software.`,
    topic: `UX-Analyse, Usability, Dashboard-Optimierung`,
    goalDetails: `
    Verstehen, Experimentieren, Ausarbeiten – nach dem Double Diamond Framework. 
    
    <br><br>Definierte und durchgeführte UX-Methoden und -Tools: 
    <ul>
      <li>Stakeholder Map</li> 
      <li>Information Architecture / Sitemap</li> 
      <li>Heuristische Evaluation nach Nielsen Norman Group</li>
      <li>Nutzerumfrage</li> 
      <li>Nutzerinterviews und Shadowing</li> 
      <li>Personas</li> 
      <li>Analytics Metriken Insights (Matomo Tracking)</li>
    </ul> <br>

    Auf Miro fand die visuelle und kollaborative Analyse statt. Vom Aufdecken der Pain Points im conn4 Dashboard bis hin zu den ersten Konzepten. Die dort validierten Lösungen wurden anschließend in Jira in konkrete User Stories überführt. <br><br>
    Jira wurde agil in einer Roadmap als zentrales Pojektmanagement-Tool verwendet, in dem Aufgaben und identifizierte UX-Pain-Points in strukturierte Tickets/User Stories überführt und priorisiert wurden.`,
    implementation: `Problem-Priorisierung mit Fokus auf Quickwins unter Verwendung existierender UI-Elemente. Site Selection, GIS Content Scheduler und Device Setup jeweils mit Scribbles, Wireframes und Mockups.`,
    designProcessHtml: ``,
    achievements: [
      `Priorisierung von 3 kritischen Problemen und deren Lösungsfindung`,
      `Fehlnutzung von Funktionen wurden erkannt und dokumentiert`,
      `Identifizierung von wiederkehrenden Problemen`,
      `Identifizierung von sich überschneidenden Pain Points aus Umfrage und Interviews`
    ],
    goals: [
      `Verbesserung der Nutzerzufriedenheit`,
      `Effizienzsteigerung des Dashboards`,
      `Etablierung nutzerzentrierter Softwareentwicklung`
    ]
  },
  {
    id: `Proj08`,
    title: `Mitarbeiter Dashboard Touchscreen Design`,
    thumbnailClass: `thumbnail-pic-08`,
    shortDesc: {
      mobile: `Touchscreen-Design für das Mitarbeiter Dashboard`,
      tablet: `Touchscreen-Design für das Mitarbeiter Dashboard m3connect`,
      desktop: `Touchscreen-Design für das Mitarbeiter Dashboard m3connect`
    },
    tags: [`Konzeption`, `Design`, `Touchscreen`, `Dashboard`, `UX`, `UI`],
    verwendeTools: [`sketching`, `xd`],
    prototypeLink: null,
    prototypeText: null,
    finalDesignCarousel: [
      './lib/images/m3c-ui-design-ma-dashboard/ma-dashboard-kiosk-final.png',
      './lib/images/m3c-ui-design-ma-dashboard/MADB-Mainscreen-dark.jpg'
    ],
    background: `Das Mitarbeiter Dashboard wurde als Touchscreen-Anwendung konzipiert.
  <a href="./lib/images/m3c-ui-design-ma-dashboard/how-it-started.png" class="glightbox" data-gallery="proj08">
    <img data-src="./lib/images/m3c-ui-design-ma-dashboard/how-it-started.png" class="lazyload my-3 w-100 rounded-lg border shadow">
  </a>`,
    duration: ``,
    team: ``,
    goalText: ``,
    topic: `Touchscreen-Dashboard, UI-Design`,
    goalDetails: ``,
    implementation: ``,
    designProcessHtml: ``,
    achievements: [],
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `xd`, `msteams`, `jira`, `invision`],
    ...
    designProcessHtml: `
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design1.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Konzeptionsansatz für die Suchfunktion; description: .ssb-desc1; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design2.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Sketching and iterating Wire Flow; description: .ssb-desc2; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design3.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc3; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design4.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc4; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design5.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc5; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design6.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc6; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design7.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc7; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design8.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc8; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design9.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc9; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design10.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc10; descPosition: bottom;">
      ...
      <a href="./lib/images/ssb-collapseBody/ssb-design11.png" class="glightbox" data-gallery="proj01" data-glightbox="title: Positionierung der Suchleiste; description: .ssb-desc11; descPosition: bottom;">
      ...
      <a href="./lib/video/clips/ssb-prototype-demo2.mp4" class="glightbox" data-gallery="proj01">
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `xd`, `msteams`, `jira`],
    ...
    designProcessHtml: `
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design1.png" class="glightbox" data-gallery="proj02" data-glightbox="title:UX-Huddle Session Verbandbuch; description: .dvb-desc1; descPosition: bottom;">
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design2.png" class="glightbox" data-gallery="proj02" data-glightbox="title:Verbandbuch-Skizzen; description: .dvb-desc2; descPosition: bottom;">
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design3.png" class="glightbox" data-gallery="proj02" data-glightbox="title:Verbandbuch Interaktiver Prototyp; description: .dvb-desc3; descPosition: bottom;">
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design4.png" class="glightbox" data-gallery="proj02" data-glightbox="title:Verbandbuch Interaktiver Prototyp; description: .dvb-desc4; descPosition: bottom;">
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design5.png" class="glightbox" data-gallery="proj02" data-glightbox="title:Verbandbuch Interaktiver Prototyp; description: .dvb-desc5; descPosition: bottom;">
      ...
      <a href="./lib/images/dvb-collapseBody/dvb-design6.png" class="glightbox" data-gallery="proj02" data-glightbox="title:Verbandbuch Interaktiver Prototyp; description: .dvb-desc6; descPosition: bottom;">
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `vscode`, `bootstrap-4`, `html-5`, `css-3`, `javascript`, `jquery`],
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `axure`, `photoshop-cc`, `vscode`, `html-5`, `css-3`, `angular`, `typescript`, `javascript`, `jquery`, `jira`, `github-octocat`],
    prototypeLink: `./lib/prototype/ip40/dashboard.html`,
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `illustrator`, `photoshop-cc`, `vscode`],
    prototypeLink: null,
    prototypeText: null,
    finalDesignCarousel: [],
  ...
  },
  {
    ...
    verwendeTools: [`sketching`, `illustrator`, `xd`],
