document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (kontextWrap) {
        const noteLabels = ["Kommunikation", "Zielgruppe", "Design System", "Figma", "8pt-grid", "User Experience", "Whitespace", "Wireframes", "Konzeption", "Nutzerverhalten", "Emotion Design", "Touch Points", "Usability", "Prototyping", "Persona", "User Research", "Interaktion", "User Flow", "Microinteractions", "Motion Design", "Usability Heuristics", "User Interface"];
