...
const BLANK_GIF = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==';
  ...
  const iconMap = {
    ...
    miro:        { src: './lib/images/icons/miro.svg', title: 'Miro - Digital Whiteboard' },
    figma:       { src: './lib/images/icons/figma.svg', title: 'Figma - UI Design Tool' }
  };
  ...
  function buildCollapseContent(project) {
    ...
    // Top images (before tools)
    if (project.bilderOben) {
      html += project.bilderOben;
    }
